    ...
    search_products: tool({
      ...
      execute: async ({ query, category }, options = {}) => {
        ...
        const defaultCategory =
          !userIntentCategory && !category && !queryIntentCategory
            ? currentProduct?.category
            : undefined;
        const resolvedCategory =
          userIntentCategory || category || queryIntentCategory || defaultCategory;

        const enrichedQuery =
          currentProduct && !userIntentCategory && !category && !queryIntentCategory
